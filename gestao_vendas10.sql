create database gestao_venda2021;

use gestao_venda2021; 
...
insert into usuario(nome, username, senha) values ('Quitumba Ferreira', 'quitumba', '123456');

select * from usuario;

SELECT * FROM usuario WHERE username = 'quitumba';
